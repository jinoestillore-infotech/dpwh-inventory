...
<div class="text-white p-2 min-vh-100 mt-4">
    ...
    <ul class="nav flex-column">
        ...
        <li class="nav-item mb-2">
            <a href="../assets/asset.php" class="nav-link text-white">
        ...
        <li class="nav-item mb-2">
            <a href="../user/user_permissions.php" class="nav-link text-danger">
        ...
        <li class="nav-item mb-2">
            <a href="../logs/logs.php" class="nav-link text-white">
